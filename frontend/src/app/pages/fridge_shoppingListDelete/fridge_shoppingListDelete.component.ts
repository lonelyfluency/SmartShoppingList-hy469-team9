...
@Component({
  selector: 'app-fridge_shoppingListDelete',
  templateUrl: './fridge_shoppingListDelete.component.html',
  styleUrls: ['./fridge_shoppingListDelete.component.scss']
})
export class FridgeShoppingListDeleteComponent {
