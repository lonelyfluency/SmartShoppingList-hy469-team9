...
@Component({
  selector: 'app-shoppinglist-phone',
  templateUrl: './shoppinglist_phone.component.html',
  styleUrls: ['./shoppinglist_phone.component.scss']
})
export class ShoppinglistPhoneComponent implements OnInit {
